...
STRINGS = {
    'en': {
        ...
        # === GEAR_LIBRARY.py NEW gear prompts ===============================
        'prompt_gear_name': 'Gear name: ',
        'prompt_alpha': 'Pressure angle (default: 20) / °: ',
        'prompt_beta': 'Helix angle / °: ',
        'prompt_module': 'Gear module / mm: ',
        'prompt_z1': 'z1: ',
        'prompt_z2': 'z2: ',
        'prompt_x1': 'Pinion profile shift x1: ',
        'prompt_x2': 'Wheel profile shift x2: ',
        'prompt_addendum_reduction': 'Calculate addendum reduction factor (Y/N): ',
        'prompt_b1': 'Pinion facewith b1: ',
        'prompt_b2': 'Wheel facewith b2: ',
        'prompt_ds1': 'Pinion shaft ds1: ',
        'prompt_ds2': 'Wheel shaft ds2: ',
        'prompt_haP': 'Addendum coefficient (default: 1): ',
        'prompt_hfP': 'Deddendum coefficient (default: 1.25): ',
        'prompt_rfP': 'Root radius coefficient (default: 0.38): ',
        'cli_surface_finishing': 'Gear surface finishing:',
        'prompt_ra1': 'Ra1 (default: 0.6) / μm: ',
        'prompt_ra2': 'Ra2 (default: 0.6) / μm: ',
        'prompt_rq1': 'Rq1 (default: 0.7) / μm: ',
        'prompt_rq2': 'Rq2 (default: 0.7) / μm: ',
        'prompt_rz1': 'Rz1 (default: 4.8) / μm: ',
        'prompt_rz2': 'Rz2 (default: 4.8) / μm: ',
    ...
    'ru': {
        ...
        # === GEAR_LIBRARY.py prompts для новой геометрии =====================
        'prompt_gear_name': 'Название передачи: ',
        'prompt_alpha': 'Угол профиля α (по умолчанию 20) / °: ',
        'prompt_beta': 'Угол наклона зуба β / °: ',
        'prompt_module': 'Модуль m / мм: ',
        'prompt_z1': 'Число зубьев шестерни z1: ',
        'prompt_z2': 'Число зубьев колеса z2: ',
        'prompt_x1': 'Коэф. смещения шестерни x1: ',
        'prompt_x2': 'Коэф. смещения колеса x2: ',
        'prompt_addendum_reduction': 'Рассчитать коэф. укорочения зуба (Y/N): ',
        'prompt_b1': 'Ширина венца шестерни b1 / мм: ',
        'prompt_b2': 'Ширина венца колеса b2 / мм: ',
        'prompt_ds1': 'Диаметр вала шестерни ds1 / мм: ',
        'prompt_ds2': 'Диаметр вала колеса ds2 / мм: ',
        'prompt_haP': 'Коэф. высоты головки haP (по умолчанию 1): ',
        'prompt_hfP': 'Коэф. высоты ножки hfP (по умолчанию 1.25): ',
        'prompt_rfP': 'Коэф. радиуса впадин rfP (по умолчанию 0.38): ',
        'cli_surface_finishing': 'Параметры шероховатости поверхности зубьев:',
        'prompt_ra1': 'Ra1 (по умолчанию 0.6) / мкм: ',
        'prompt_ra2': 'Ra2 (по умолчанию 0.6) / мкм: ',
        'prompt_rq1': 'Rq1 (по умолчанию 0.7) / мкм: ',
        'prompt_rq2': 'Rq2 (по умолчанию 0.7) / мкм: ',
        'prompt_rz1': 'Rz1 (по умолчанию 4.8) / мкм: ',
        'prompt_rz2': 'Rz2 (по умолчанию 4.8) / мкм: ',
